...
"""
            ...
            await conn.exec_driver_sql("DROP TABLE IF EXISTS orderbook_real_levels_1m;")
            await conn.exec_driver_sql("DROP TABLE IF EXISTS price_impact_wall_candidates;")
        return
...
"""
        ...
        # 清理已废弃的 wall 相关表
        await conn.exec_driver_sql("DROP TABLE IF EXISTS orderbook_real_levels_1m CASCADE;")
        await conn.exec_driver_sql("DROP TABLE IF EXISTS price_impact_wall_candidates CASCADE;")
